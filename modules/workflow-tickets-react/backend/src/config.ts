...
export const config = {
  ...
  timelineHistoryMax: numberEnv("TOOLNEST_WORKFLOW_TIMELINE_HISTORY_MAX", 5_000, 100, 100_000),
  actionExecutionHistoryMax: numberEnv("TOOLNEST_WORKFLOW_ACTION_HISTORY_MAX", 2_000, 100, 100_000),
  scheduleRunHistoryMax: numberEnv("TOOLNEST_WORKFLOW_SCHEDULE_RUN_HISTORY_MAX", 2_000, 100, 100_000),
};
