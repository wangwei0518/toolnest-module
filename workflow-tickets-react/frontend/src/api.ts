...
export interface FormField { id: string; type: string; label: string; description?: string; placeholder?: string; required?: boolean; default?: unknown; options?: Array<{ label: string; value: string | number }>; config?: Record<string, unknown>; reference?: { path?: string } }
...
export interface TicketNode { id: Id; node_id: Id; name: string; key: string; status: Status; values: Record<string, unknown>; outputs: Array<Record<string, unknown>>; resources: Record<string, Record<string, unknown>>; blocked_reason: string; started_at?: string | null; completed_at?: string | null }
export interface TicketAttachment { id: Id; name: string; filename: string; mime_type: string; size: number; url: string }
export interface Ticket { id: Id; number: string; title: string; note: string; status: Status; priority: Status; tags: string[]; workflow_id: Id; workflow_version_id: Id; workflow_name: string; project_id?: Id | null; milestone_id?: Id | null; created_by: string; owner_name?: string | null; due_at?: string | null; reminder_at?: string | null; attachments?: TicketAttachment[]; created_at: string; updated_at: string; node_instances: TicketNode[] }
