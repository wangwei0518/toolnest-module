...
function ticketReturnPath(query: Record<string, string> = {}) { if (query.from !== "project" || !query.project_id) return "/modules/workflow-tickets-react/tickets"; const tab = query.project_tab && query.project_tab !== "overview" ? "?tab=" + encodeURIComponent(query.project_tab) : ""; return "/modules/workflow-tickets-react/projects/" + encodeURIComponent(query.project_id) + tab; }
